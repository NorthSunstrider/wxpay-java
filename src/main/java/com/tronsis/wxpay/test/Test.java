...
public class Test {
	...
	public static void testUnifiedOrder() {
		...
		unifiedOrderRequest.setSpbill_create_ip("59.40.98.35");
		unifiedOrderRequest.setNotify_url("demo.tronsis.com:8081/easyprint/ws/api/wxpay/unified_order/callback");
